...
class RCTextMessageCell: RCMessageCell {
	...
	class func size(_ indexPath: IndexPath, messagesView: RCMessagesView) -> CGSize {
		...
		let rect = rcmessage.text.boundingRect(with: CGSize(width: maxwidth, height: CGFloat.greatestFiniteMagnitude), options: .usesLineFragmentOrigin, attributes: [NSAttributedStringKey.font: RCMessages().textFont], context: nil)
