...
@objc class RCMessages: NSObject {
	...
	var statusInset: UIEdgeInsets			= UIEdgeInsetsMake(5.0, 10.0, 5.0, 10.0)
	...
	var textInset: UIEdgeInsets				= UIEdgeInsetsMake(10.0, 10.0, 10.0, 10.0)
	...
	var emojiInset: UIEdgeInsets			= UIEdgeInsetsMake(10.0, 10.0, 10.0, 10.0)
